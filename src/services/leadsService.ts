...
-- Each consultant can delete their own leads; admin/manager can delete
-- anyone's, matching the app's RBAC gate on deleteCard().
DROP POLICY IF EXISTS "Only admin or manager can delete leads" ON leads;
